...
<div class="container">
    ...
    <table id="listagem" class="listagem">
        ...
        <tbody>
        <?php
        $query = $this->noticia->GetNoticia("secundaria");
            ...
            <tr <?= $disabled ?>>
                ...
                <td>
                    <?php if ($dados->status == 1) { ?>
                        <?= anchor("noticia/desativarNoticiaSecundaria/?id=$dados->id", $desativar, "title='Desativar' class='desativaRegistro'") ?> <?= anchor("noticia/excluirNoticiaSecundaria/?id=$dados->id", $trash, "title='Excluir' class='deletaRegistro'") ?></td>
                    <?php } else { ?>
                        <?= anchor("noticia/ativarNoticiaSecundaria/?id=$dados->id", $ativar, "title='Ativar' class='ativaRegistro'") ?> <?= anchor("noticia/excluirNoticiaSecundaria/?id=$dados->id", $trash, "title='Excluir' class='deletaRegistro'") ?></td>
                    <?php } ?>
            </tr>
        <?php } ?>
        </tbody>
