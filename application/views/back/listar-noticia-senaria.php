...
<div class="container">
    ...
    <table id="listagem" class="listagem">
        ...
        <tbody>
        <?php
        $query = $this->noticia->GetNoticia("senaria");
            ...
            <tr <?= $disabled ?>>
                ...
                <td>
                    <?php if ($dados->status == 1) { ?>
                        <?= anchor("noticia/desativarNoticiaSenaria/?id=$dados->id", $desativar, "title='Desativar' class='desativaRegistro'") ?> <?= anchor("noticia/excluirNoticiaSenaria/?id=$dados->id", $trash, "title='Excluir' class='deletaRegistro'") ?></td>
                    <?php } else { ?>
                        <?= anchor("noticia/ativarNoticiaSenaria/?id=$dados->id", $ativar, "title='Ativar' class='ativaRegistro'") ?> <?= anchor("noticia/excluirNoticiaSenaria/?id=$dados->id", $trash, "title='Excluir' class='deletaRegistro'") ?></td>
                    <?php } ?>
            </tr>
        <?php } ?>
        </tbody>
