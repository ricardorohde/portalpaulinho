...
<div class="container">
    ...
    <table id="listagem" class="listagem">
        ...
        <tbody>
        <?php
        $query = $this->noticia->GetNoticia("quinaria");
            ...
            <tr <?= $disabled ?>>
                ...
                <td>
                    <?php if ($dados->status == 1) { ?>
                        <?= anchor("noticia/desativarNoticiaQuinaria/?id=$dados->id", $desativar, "title='Desativar' class='desativaRegistro'") ?> <?= anchor("noticia/excluirNoticiaQuinaria/?id=$dados->id", $trash, "title='Excluir' class='deletaRegistro'") ?></td>
                    <?php } else { ?>
                        <?= anchor("noticia/ativarNoticiaQuinaria/?id=$dados->id", $ativar, "title='Ativar' class='ativaRegistro'") ?> <?= anchor("noticia/excluirNoticiaQuinaria/?id=$dados->id", $trash, "title='Excluir' class='deletaRegistro'") ?></td>
                    <?php } ?>
            </tr>
        <?php } ?>
        </tbody>
