<hr/>
<?php
$query = $this->noticia->GetNoticiaByUrl($this->input->get("url"), "secundaria")->row();
?>
<div class="container">
    <div class="row">
        <div class="blog-post">
            ...
            <br/>
            <a target="_blank"
               href="http://www.facebook.com/sharer.php?u=<?=urlencode(base_url('/noticia/visualizarNoticiaSecundaria/?url=' . $query->url))?>">
