<hr/>
<?php
$query = $this->noticia->GetNoticiaByUrl($this->input->get("url"), "quaternaria")->row();
?>
<div class="container">
    <div class="row">
        <div class="blog-post">
            ...
            <br/>
            <a target="_blank"
               href="http://www.facebook.com/sharer.php?u=<?=urlencode(base_url('/noticia/visualizarNoticiaQuaternaria/?url=' . $query->url))?>">
